...
public class TestCase_BCDIntegrationGroups extends TestBase {


	@BeforeMethod
	public void beforeClass() {
		String testName = "TestCase_BCDIntegrationGroups";
	...
	@Test(dataProvider = "bcdGroupProvider", dataProviderClass = DP.class)
	public void bcdGroupIntegration(String bcdGroup) throws InterruptedException {
		...
		rbga.addApprover(bcdGroup);

		String actualUser = bcdGroup;
		Log.info("Actual user added is " + actualUser);
	
		boolean actual = true;

		boolean expected = rbga.ExpectedGroup();
