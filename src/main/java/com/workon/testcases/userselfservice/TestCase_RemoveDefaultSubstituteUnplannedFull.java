...
public class TestCase_RemoveDefaultSubstituteUnplannedFull {

	
	@BeforeMethod
	public void beforeClass() throws InterruptedException, IOException {
		String testName = "TestCase_RemoveDefaultSubstituteUnplannedFull";
	...
	public void removeDefaultSubstitueUnplannedFull(String ntid) throws InterruptedException {
		...
		DashboardPage dp = new DashboardPage();
	 	...
	 	substitute.removeDefaultSubstitute();
