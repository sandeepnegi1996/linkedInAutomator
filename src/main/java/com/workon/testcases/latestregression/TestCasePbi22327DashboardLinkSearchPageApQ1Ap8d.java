...
public class TestCasePbi22327DashboardLinkSearchPageApQ1Ap8d extends TestBase{
	
	@BeforeMethod
	public void setTestName() {

		String testName = "TestCasePbi22327DashboardLinkSearchPageApQ1Ap8d";
	...
	public void verifyDashboardLinkInSearchRequestPage() throws InterruptedException {
		Log.startTestCase("verifyDashboard Link in Search Page");

		LoginPage login = new LoginPage();
		DashboardPage dp = login.doLogin();
		SearchPage sp = dp.gotoSearchBox();
		SearchRequestPage searchRequestPage = sp.gotoSearchRequestAp8d();
		...
		Log.endTestCase("verifyDashboard");
